...
<body>
    ...
    <div class="form-row">
        <form action="validar_agregar.php" method="POST">
            <input type="number" name="id" placeholder="id" class="form-control d-none"/>
            ...
            <input type="number" name="celular" placeholder="celular" class="form-control" required />
            <input type="text" name="correo" placeholder="correo" class="form-control" required />
            <input type="text" name="logo" placeholder="logo" class="form-control" required />
            <input type="submit" />
        </form>
    </div>
